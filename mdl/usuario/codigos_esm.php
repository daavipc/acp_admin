...
if($_POST['form'] == 'form') {
	...
	if($prosseguir) {
		...
		if($insert) {
			$core->logger("O usuário gerou um código de esmeraldas.", "acao");
...
<div class="box-content">
	...
	$form->createInput('Quantidade de esmeraldas', 'text', 'moedas', '', 'w-md', '', 'Apenas números.<br>A quantidade de esmeraldas que este código dará ao usuário quando gerado.');
...
<div class="box-content">
	...
	<div class="well">
		...
		<b>Quantidade de esmeraldas:</b> <?=$core->clear($sql2['qtd_ids']);?><br>
